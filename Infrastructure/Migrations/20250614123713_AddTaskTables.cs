        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceivedId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Chats_SenderId_ReceivedId",
                table: "Chats",
                columns: new[] { "SenderId", "ReceivedId" },
                unique: true,
                filter: "[SenderId] IS NOT NULL AND [ReceivedId] IS NOT NULL");
